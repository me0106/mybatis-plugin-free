...
public class ParamJdbcTypeValueImpl extends ASTWrapperPsiElement implements ParamJdbcTypeValue {

  public ParamJdbcTypeValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ParamVisitor visitor) {
    visitor.visitJdbcTypeValue(this);
  }
