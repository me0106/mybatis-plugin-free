...
public class ParamModeValueImpl extends ASTWrapperPsiElement implements ParamModeValue {

  public ParamModeValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ParamVisitor visitor) {
    visitor.visitModeValue(this);
  }
