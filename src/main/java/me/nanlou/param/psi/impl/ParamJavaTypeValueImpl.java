...
public class ParamJavaTypeValueImpl extends ASTWrapperPsiElement implements ParamJavaTypeValue {

  public ParamJavaTypeValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ParamVisitor visitor) {
    visitor.visitJavaTypeValue(this);
  }
